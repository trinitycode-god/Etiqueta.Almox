...
// ---------------------------------------------------------
const GOOGLE_APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbz_zQdnbGQiJrcK-1eCAsZjmqTHKBpvy1HSEplKp6KMF3sCCtL_RQR81CqfDUIw7-g9/exec";
...
const el = {
  ...
  etqLote: document.getElementById("etqLote"),
...
function atualizarEtiqueta() {
  ...
  el.etqBarcodeNumero.textContent = codigo;

  atualizarBarcode(codigo);
}

function atualizarBarcode(codigo) {
  try {
    if (typeof JsBarcode === "undefined") return;
    JsBarcode(el.etqBarcodeSvg, codigo, {
      format: "CODE128",
      lineColor: "#0a0a0a",
      width: 2,
      height: 55,
    ...
    // Código inválido para geração de barras (ex: campo vazio) — ignora silenciosamente
  }
}
